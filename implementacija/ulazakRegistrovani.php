        ...
        <div class="col-md-4 col-xs-12">
          <div class="collapse text-center d-md-block" id="side-nav">
            ...
            <div class="list-group text-center mb-2">
              ...
              <a href="ulazakRegistrovani.php" class="list-group-item list-group-item-action py-4 active">ULAZAK REGISTROVANI</a>
              <a href="izlazak.php" class="list-group-item list-group-item-action py-4">IZLAZAK</a>
            </div>
          </div>
        </div>
        <div class="col-md-8 col-xs-12">
            <div class="jumbotron pt-0 mb-1">
                ...
                <form method="POST" action="<?php print $_SERVER['PHP_SELF']; ?>" autocomplete="off">
                  ...
                  <div class="row justify-content-center">
                    <div class="col-lg-9">
                      <button type="submit" name="evidentirajUlazak" class="btn btn-plavi btn-block mt-3 py-3">EVIDENTIRAJ ULAZAK</button>
                    </div>
                  </div>
                </form>
            </div>
